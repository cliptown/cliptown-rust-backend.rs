...
check was introduced: **123 findings across 18 files
and 5,757 lines**. CI compares against that budget and fails only when a
...
| `RS001` | 46 | warn | immutable values | mutable local binding (`let mut`) |
...
*immutable values* · 46 occurrences at baseline
